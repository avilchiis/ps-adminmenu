-- ESX doesn't have a shared vehicles like qbcore so we need to create one...
-- I don't take any credit from this file, is all qbcore/shared/vehicles.lua just copy/pasted
-- If you have addon vehicles you will need to add them
ESX_VehicleHashes = ESX_VehicleHashes or {}
ESX_Vehicles = ESX_Vehicles or {}
ESX_Vehicles = {
    --- Compacts
